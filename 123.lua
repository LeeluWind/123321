...
local function checkHWID()
    ...
    local AllowedHWIDs = HttpService:JSONDecode(response)
...
wait(5)
            ...
            if currentValue > 880 and currentValue < 1000 then
             ...
             if player.PlayerGui.GameGui.Info.Message.Text == "VICTORY" then
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.GameGui.EndScreen.Rewards.DroppedTower.Visible == false then
                    local url = "https://discord.com/api/webhooks/1345128413027110952/D6lcC-kgYvGkyoY7QVrl8RNVm2bsg16CnubY1a6aXsl2odYRyim8F2sE9iPwBCBbSU-U"
    ...
    local player = game.Players.LocalPlayer
    player:Kick("Ваш HWID не находится в whitelist!")
    setclipboard(HWID)
end
